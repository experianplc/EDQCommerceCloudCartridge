 ...
 */
export function edqPhoneValidationCallback({edqValidatePhone, pageRestrictValidation, edqPhoneLineElements, edqCurrentSubmitButton}: PhoneCallbackArgs) {
	/** 
	 ...
	 */
	if ((edqValidatePhone) && (window.sfccConfig.pageRestrictValidation)) {
