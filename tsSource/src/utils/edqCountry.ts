 ...
 */
interface CountryAlpha2Args {
	incomingCountryIso2: string;
	vDefaultCountry: string;
}

interface CountryDictValue {
	key: string;
	value: string;
};

let countryDict: CountryDictValue[] = [];
 ...
 * @returns {string}
 */
export function countryAlpha3({incomingCountryIso2, vDefaultCountry}: CountryAlpha2Args) {
	let iso2ToIso3CountryDict: string;
...
interface CountryAlpha3Args {
	incomingCountryIso3: string;
}

/** 
 * Searches for the Store Country code ISO-3 and returns the ISO-2 code.
 * @param incomingCountryIso3
 *
 * @returns 
 */
export function countryAlpha2({incomingCountryIso3}: CountryAlpha3Args): CountryDictValue {

	return countryDict.filter(function(countryKeyAndValue: CountryDictValue) {
